...
#### Aggregated transmissibility

These analyses present results for the aggregated incidence, i.e. without
...
```{r rt-table-global}
res_epinow2_aggreg$estimates$summarised %>%
