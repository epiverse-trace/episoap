...
params:
  ...
  local: true
  data_file: "covid_hosp_uk_20201024.xlsx"
...
pacman::p_load("distcrete")
pacman::p_load("epitrix")
...
```{r}
if (params$local) {
  data_path <- file.path("data", params$data_file)
} else {
  data_path <- file.path("https://github.com/epiverse-trace/data_pipelines/raw/main/inst/rmarkdown/templates/transmissibility-report/skeleton/data", params$data_file)
}
```
