...
The package *i2extras* provides tools for fitting GLMs to epidemic curves, and
estimating the corresponding growth rates. Such estimate can be biased by
reporting delays. Here, we exclude the last `r params$incomplete_days` days as
incomplete, and retain a total of `r params$r_estim_window` days to estimate the
growth rate.
