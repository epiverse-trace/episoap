...
```{r, echo = FALSE, fig.cap = "Graphical interface to open a soap rmarkdown template in RStudio"}
knitr::include_graphics("../man/figures/rmarkdown_params_ask.png", dpi = 180)
```
